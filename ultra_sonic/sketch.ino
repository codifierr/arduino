...
int dry_run_check_interval = 10; // variable for the dry run check interval value 180 for 360 seconds = 6 minutes
...
int dry_run_wait_interval = 20; // variable for the dry run wait interval value 2700 for 5400 seconds = 90 minutes
...
{
    Serial.println(" Checking water level: " + String(level));
    Serial.println(" Pump Start water level: " + String(pump_start_level));
...
{
    Serial.println(" Checking dry run protect ");
    if (dry_run_wait)
    {
